...
//print_r($_REQUEST);
  //echo $_REQUEST["AccountDate"];  
    $sq="select * from oldstu_admission where student_id = '".$_REQUEST["StudentId"]."'";
    //echo $sq;
    loadFromMySQLSpecificOldStudentAnual($sq);
   ...
   //loadFromMySQLMonth("select * from account where account_date ='2018-11-16'");
    ...
    foreach($oldSpecificStudentAnual as $a)
            {
                $id = $a["id"];
                $a_date = $a["student_id"];
                $fname = $a["firstname"];
    ...
    echo "<table class='table table-bordered'>";
            ...
            echo "<tr>";
             ...
             echo "<td>"; echo  "<center>"; echo $totalduefees; echo  "</center>"; echo "</td>";
